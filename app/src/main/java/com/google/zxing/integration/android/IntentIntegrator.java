...
public class IntentIntegrator {
    ...
    public static final Collection<String> ONE_D_CODE_TYPES = list("UPC_A", "UPC_E", "EAN_8","EAN_13","CODE_39",
            "CODE_93","ITF","RSS_14","RSS_EXPANDED");
    ...
    public Collection<String> getTargetApllications(){
    ...
    public final AlertDialog initiateScan(Collection<String> desiredBarcodeFormats){
        ...
        startActivityForResults(intentScan, REQUEST_CODE);
        return null;
    }

    public void startActivityForResults(Intent intent, int code){
