...
public class Search extends AppCompatActivity {
    String searchTitle;
    private static String urlStart = "http://api.themoviedb.org/3/search/movie?api_key=13de0f310da7852b09b07e6a9f3a16ae&query=";
    public String url = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TMDBMovieAdapter(searchResults);
